...
/>
        ...
        {items.map((item, index) => (
          <div key={index} className="mb-4 grid grid-cols-1 gap-3 rounded-xl border p-4 md:grid-cols-5">
            <input className="rounded border p-3" placeholder="Ürün adı" value={item.product_name} onChange={e => updateItem(index, 'product_name', e.target.value)} />
            ...
            <div className="rounded bg-gray-100 p-3">{item.total_price} TL</div>
          </div>
        ))}
